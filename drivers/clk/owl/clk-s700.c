...
static struct owl_pll_clock s700_pll_clks[] __initdata = {
	{ CLK_CORE_PLL,   "core_pll", NULL, CLK_IS_ROOT, CMU_COREPLL, 12000000, 9, 0, 8,  4, 174, 0, NULL},
	{ CLK_DEV_PLL,    "dev_pll", NULL, CLK_IS_ROOT, CMU_DEVPLL,  6000000, 8, 0, 8, 8, 126, 0, NULL},
	{ CLK_DDR_PLL,    "ddr_pll",  NULL, CLK_IS_ROOT, CMU_DDRPLL, 6000000, 8, 0, 8,  2,  180, 0, NULL},
	{ CLK_NAND_PLL,   "nand_pll", NULL, CLK_IS_ROOT, CMU_NANDPLL,  6000000, 8, 0, 8,  2, 86, 0, NULL},
	{ CLK_DISPLAY_PLL, "display_pll", NULL, CLK_IS_ROOT, CMU_DISPLAYPLL, 6000000, 8, 0, 8, 2, 140, 0, NULL},
	{ CLK_CVBS_PLL, "cvbs_pll", NULL, CLK_IS_ROOT, CMU_CVBSPLL, 0, 8, 0, 8, 27, 43, 0, clk_cvbs_pll_table},
	{ CLK_AUDIO_PLL,  "audio_pll", NULL, CLK_IS_ROOT, CMU_AUDIOPLL, 0, 4, 0, 1, 0, 0, 0, clk_audio_pll_table},
	{ CLK_ETHERNET_PLL, "ethernet_pll", NULL, CLK_IS_ROOT, CMU_ETHERNETPLL, 500000000, 0, 0, 0, 0, 0, CLK_OWL_PLL_FIXED_FREQ, NULL},
...
static struct owl_divider_clock s700_div_clks[] __initdata = {
	{ CLK_NOC0, "noc0_clk", "noc0_clk_mux", 0, CMU_BUSCLK, 16, 2, 0, NULL,},
	{ CLK_NOC1, "noc1_clk", "noc1_clk_mux", 0, CMU_BUSCLK1, 16, 2, 0, NULL,},
	{ CLK_NOC1_CLK_DIV, "noc1_clk_div", "noc1_clk", 0, CMU_BUSCLK1, 20, 1, 0, NULL, "noc1_clk_div"},
	{ CLK_HP_CLK_DIV, "hp_clk_div", "hp_clk_mux", 0, CMU_BUSCLK1, 12, 2, 0, NULL,},
	{ CLK_AHB, "ahb_clk", "hp_clk_div", 0, CMU_BUSCLK1, 2, 2, 0, NULL, "ahb_clk"},
	{ CLK_APB, "apb_clk", "ahb_clk", 0, CMU_BUSCLK1, 14, 2, 0, NULL, "apb_clk"},

	{ CLK_SENSOR0, "sensor0", "sensor_src", 0, CMU_SENSORCLK, 0, 4, 0, NULL, "sensor0"},
	{ CLK_SENSOR1, "sensor1", "sensor_src", 0, CMU_SENSORCLK, 8, 4, 0, NULL, "sensor1"},
	{ CLK_RMII_REF, "rmii_ref", "ethernet_pll", 0, CMU_ETHERNETPLL, 2, 1, 0, rmii_div_table, "rmii_ref"},
};
...
static struct owl_gate_clock s700_gate_clks[] __initdata = {
	{ CLK_GPIO,  "gpio", "apb_clk", 0, CMU_DEVCLKEN1, 25, 0, "gpio"},
	{ CLK_DMAC,  "dmac", "hp_clk_div", 0, CMU_DEVCLKEN0, 17, 0, "dmac"},
	...
	{ CLK_I2C0, "i2c0",	"hosc", 0, CMU_DEVCLKEN1, 0, 0, "i2c0"},
	{ CLK_I2C1, "i2c1",	"hosc", 0, CMU_DEVCLKEN1, 1, 0, "i2c1"},
	{ CLK_I2C2, "i2c2",	"hosc", 0, CMU_DEVCLKEN1, 2, 0, "i2c2"},
	{ CLK_I2C3, "i2c3",	"hosc", 0, CMU_DEVCLKEN1, 3, 0, "i2c3"},

	{ CLK_SPI0, "spi0",	"ahb_clk", 0, CMU_DEVCLKEN1, 4, 0, "spi0"},
	{ CLK_SPI1, "spi1",	"ahb_clk", 0, CMU_DEVCLKEN1, 5, 0, "spi1"},
	{ CLK_SPI2, "spi2",	"ahb_clk", 0, CMU_DEVCLKEN1, 6, 0, "spi2"},
	{ CLK_SPI3, "spi3",	"ahb_clk", 0, CMU_DEVCLKEN1, 7, 0, "spi3"},
...
static struct owl_composite_clock s700_composite_clks[] __initdata = {
	...
	COMP_DIV_CLK(CLK_UART1, "uart1", 0,
			...
			C_DIVIDER(CMU_UART1CLK, 0, 8, NULL,  CLK_DIVIDER_ROUND_CLOSEST)),
	...
	COMP_DIV_CLK(CLK_SENOR_SRC, "sensor_src", 0,
...
CLK_OF_DECLARE(s700_clk, "actions,s700-clock", s700_clk_init);
